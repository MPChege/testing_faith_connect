...
const steps = [
  {
    ...
    content: "We're excited to have you join our community. Faith Connect helps you find meaningful employment opportunities within our church family and beyond.",
    color: "from-fem-navy to-fem-terracotta"
  },
  {
    title: "What is Faith Connect?",
    subtitle: "Connecting hearts and opportunities",
    content: "Faith Connect is a platform that connects job seekers and employers in our faith community. You can create a profile, browse jobs, apply, and communicate directly with employers.",
    color: "from-fem-terracotta to-fem-gold"
  },
  {
    title: "Step 1: Complete Your Profile",
    subtitle: "Build your professional presence",
    content: "Start by filling out your profile. This helps employers get to know you and match you with the right opportunities.",
    color: "from-fem-gold to-fem-navy"
  },
  {
    title: "Step 2: Browse and Apply for Jobs",
    subtitle: "Discover your perfect opportunity",
    content: "Explore job listings tailored for our community. Apply to positions that match your skills and interests.",
    color: "from-fem-navy to-fem-terracotta"
  },
  {
    title: "Step 3: Message Employers",
    subtitle: "Connect directly with opportunities",
    content: "Use our built-in chat to communicate with employers, ask questions, and schedule interviews.",
    color: "from-fem-terracotta to-fem-gold"
  },
  {
    title: "You're Ready!",
    subtitle: "Let's begin your journey",
    content: "You're all set to start your journey with Faith Connect. Click 'Get Started' to begin exploring opportunities!",
    color: "from-fem-gold to-fem-navy"
  }
];
